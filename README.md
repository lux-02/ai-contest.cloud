...
| 2026-03-28 | [제1회 꿈꾸는 아리랑 AI 뮤직비디오 공모전](https://ai-contest-cloud.vercel.app/contests/1-ai) | 함께봄 주식회사 | 약 500만원 | 생성형 AI |
...
- [/Users/lux/Documents/ai-contest.cloud/app/api/internal/contest-reminders/drain/route.ts](/Users/lux/Documents/ai-contest.cloud/app/api/internal/contest-reminders/drain/route.ts)
...
- async jobs
- reminder email drain + delivery log
- CI: lint + build
...
REMINDER_JOB_RUNNER_BASE_URL=http://127.0.0.1:3000
REMINDER_JOB_RUNNER_SECRET=...
APP_BASE_URL=https://www.ai-contest.cloud
RESEND_API_KEY=...
...
개발 환경에서는 일부 seed/mock 보조 데이터가 있을 수 있지만, 프로덕션 경로는 로드 실패를 더 이상 mock으로 숨기지 않습니다.  
...
- `contest-reminders.yml`
  - daily reminder drain trigger
