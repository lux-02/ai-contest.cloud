...
function getPosterAccent(category?: Contest["aiCategories"][number]) {
  switch (category) {
    case "llm-agents":
      return "from-[#0b0f14] via-[#121923] to-[#18202b]";
    case "generative-ai":
      return "from-[#0e0d12] via-[#17131d] to-[#211927]";
    case "computer-vision":
      return "from-[#0b1010] via-[#10191b] to-[#132126]";
    case "multimodal-ai":
      return "from-[#0d0d12] via-[#141722] to-[#191d2b]";
    default:
      return "from-[#0b0d10] via-[#121720] to-[#18202a]";
  }
}
...
export function ContestPoster({ contest }: ContestPosterProps) {
  ...
  return (
    <div className={`poster-shell bg-gradient-to-br ${getPosterAccent(leadCategory)}`}>
      ...
      <div className="absolute -right-10 top-5 h-32 w-32 rounded-full bg-[rgba(139,164,216,0.14)] blur-3xl" />
      <div className="absolute left-8 top-20 h-40 w-40 rounded-full border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)]" />
      <div className="relative flex h-full flex-col justify-between p-5 text-[var(--foreground)]">
        <div>
          ...
          <div className="mt-3 inline-flex rounded-full border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.04)] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--foreground)]">
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-2 text-xs text-[var(--foreground)]">
            <div className="rounded-[18px] border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] px-3 py-3">
