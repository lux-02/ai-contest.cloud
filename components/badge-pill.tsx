...
const badgeToneMap: Record<ContestBadge, string> = {
  ...
  global: "border-[rgba(17,17,17,0.1)] bg-[rgba(17,17,17,0.04)] text-[var(--foreground)]",
  trending_ai: "border-[rgba(17,17,17,0.12)] bg-[rgba(17,17,17,0.04)] text-[var(--foreground)]",
  developer_friendly: "border-[rgba(17,17,17,0.1)] bg-[rgba(17,17,17,0.04)] text-[var(--foreground)]",
